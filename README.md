...
A simple console-based **task & list organizer** with item descriptions, search functions, deadlines, statistics, and a built-in **XP leveling system** to make productivity fun.  
For all of that and more, **happy coding and testing : )**
...
- Title  
- Category (Work, School, Personal, etc.)  
- Optional deadline + priority  
- Optional notes  
- Multiple items  
- Multiple descriptions per item  

You can review and edit fields before finalizing the list.

---

### ✔️ View Lists  
View all created lists, including:
...
Also includes **search by keyword**.

---

### ✔️ Edit Lists  
Modify any part of a list:
- Add new items  
- Edit item text  
- Delete items  
...
- Swap item order  
- Rename list  
- Edit item descriptions (add, edit, delete, reorder)  
- Search items  

---

### ✔️ Delete Lists  
Remove selected lists entirely.  
The program rebuilds all list data structures safely.

---

### ✔️ Search System  
- Search list names  
- Search items inside a list  
...
- Add item → +5 XP  
- Add description → +1 XP  
- Mark done → +8 XP  
- Full list completion → +50 XP  
- Create list → +10 XP  
- Delete item → +2 XP  

100 XP = Level Up  
A live **XP bar** appears in the main menu when enabled.
